<menu>
    <div class="menu-window">
        <div class="menu-toolbar">
            <div class="menu-toolbar-icon"></div>
            <div class="menu-toolbar-account">
                Jane Doe
        ...
        <div class="menu-contact">
            <p>Contact Us</p>
            <a href="#" class="btn secondary small">Call</a>
            <a href="#" class="btn secondary small">Chat</a>
        </div>
    </div>
    <div class="menu-window active">
        <div class="menu-toolbar subsection">
            <a href="#" class="icon" type="chevron-left">Collections</a>
        </div>
